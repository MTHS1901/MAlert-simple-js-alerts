...
.mAlertModal div::-webkit-scrollbar-thumb:active {
	...
	// Cria um elemento temporário para converter HTML string em elemento DOM
	...
	setTimeout(() => {
		...
		const modalEl = alertEl.querySelector('.mAlertModal');
	...
	if (closeButton) {
		closeButton.addEventListener('click', function() {
			...
			modalEl.style.transform = 'translate(-50%, -50%) scale(0.7)';
